...
public class TileMap_HexFlatTopOddQ : TileMap 
{
	...
	public override void CreatePaths()
	{
		...
		for (int i = 0; i < rows; i ++) 
		{
			for (int j = 0; j < columns; j ++) 
			{
				...
				//TOP-RIGHT
				__conections.Add (__hex.positionOnGrid.x == columns - 1 || ((__hex.positionOnGrid.y == 0 && __hex.positionOnGrid.x % 2 == 0)) ? false : GetRandomConection());
				//BOTTOM-RIGHT
				__conections.Add (__hex.positionOnGrid.x == columns - 1 || ((__hex.positionOnGrid.y == rows - 1 && __hex.positionOnGrid.x % 2 == 1)) ? false : GetRandomConection());
				//BOTTOM
				__conections.Add ((__hex.positionOnGrid.y == (rows - 1)) ? false : GetRandomConection());
				//BOTTOM-LEFT
				__conections.Add ((__hex.positionOnGrid.x == 0 || (__hex.positionOnGrid.y == rows - 1 && __hex.positionOnGrid.x % 2 == 1)) ? false : GetRandomConection());
				//TOP-LEFT
				__conections.Add (__hex.positionOnGrid.x == 0 || ((__hex.positionOnGrid.y == 0 && __hex.positionOnGrid.x % 2 == 0)) ? false : GetRandomConection());
				//TOP
